...
describe Day14 do
  it { Day14.run("./src/inputs/day14.txt").should eq({1061, 25055}) }
end

describe Day15 do
  it { Day15.run("./src/inputs/day15.txt").should eq({4793062, 10826395253551}) }
end

describe Day16 do
  it { Day16.run("./src/inputs/day16.txt").should eq({1460, 2117}) }
end

describe Day17 do
  it { Day17.run("./src/inputs/day17.txt").should eq({3168, 1554117647070}) }
end

describe Day18 do
  it { Day18.run("./src/inputs/day18.txt").should eq({4364, 2508}) }
end

describe Day19 do
  it { Day19.run("./src/inputs/day19.txt").should eq({1589, 29348}) }
end

describe Day20 do
  it { Day20.run("./src/inputs/day20.txt").should eq({2622, 1538773034088}) }
end

describe Day21 do
  it { Day21.run("./src/inputs/day21.txt").should eq({256997859093114, 3952288690726}) }
end

describe Day22 do
  it { Day22.run("./src/inputs/day22.txt").should eq({27436, 15426}) }
end

describe Day23 do
  it { Day23.run("./src/inputs/day23.txt").should eq({3996, 908}) }
end
